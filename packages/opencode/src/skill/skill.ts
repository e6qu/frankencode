...
export namespace SkillService {
  export interface Service {
    ...
    readonly meta: (name: string) => Effect.Effect<Skill.Meta | undefined>
    readonly all: () => Effect.Effect<Skill.Meta[]>
    readonly dirs: () => Effect.Effect<string[]>
    readonly available: (agent?: Agent.Info) => Effect.Effect<Skill.Meta[]>
  }
}
  ...
  static readonly layer = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      return SkillService.of({
        ...
        meta: Effect.fn("SkillService.meta")(function* (name: string) {
          yield* Effect.promise(() => ensureScanned())
          const skill = skills[name]
          if (!skill) return undefined
          return { name: skill.name, description: skill.description, location: skill.location }
        }),
        all: Effect.fn("SkillService.all")(function* () {
          yield* Effect.promise(() => ensureScanned())
          return Object.values(skills).map((s) => ({ name: s.name, description: s.description, location: s.location }))
        }),
