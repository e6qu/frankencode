  ...
  test("filters by directory", async () => {
    await Instance.provide({
      ...
      fn: async () => {
        ...
        const sessions = [...Session.list({ directory: projectRoot, project: InstanceALS.project })]
  ...
  test("filters root sessions", async () => {
    await Instance.provide({
      ...
      fn: async () => {
        ...
        const sessions = [...Session.list({ roots: true, project: InstanceALS.project })]
        const ids = sessions.map((s) => s.id)
  ...
  test("filters by start time", async () => {
    await Instance.provide({
      ...
      fn: async () => {
        ...
        const sessions = [...Session.list({ start: futureStart, project: InstanceALS.project })]
  ...
  test("filters by search term", async () => {
    await Instance.provide({
      ...
      fn: async () => {
        ...
        const sessions = [...Session.list({ search: "unique-search", project: InstanceALS.project })]
  ...
  test("respects limit parameter", async () => {
    await Instance.provide({
      ...
      fn: async () => {
        ...
        const sessions = [...Session.list({ limit: 2, project: InstanceALS.project })]
